...
sim_ERADE <-  function(N=200, dist="bern", K=1, par1 = c(0,0), par2 = NULL, measure="sd", burnin=3, ar="WMW",nsim=10^4, alpha=0.05, one.sided = FALSE){
...
two_arm_ERADE = function(N=200, dist="bern",  par1 = c(0,0), par2 = NULL, measure="sd", burnin=3, ar="WMW", alphaE=0.5, Z_corrected=FALSE, first=FALSE){
...
sim_ERADE(N=200, dist="bern", K=1, par1 = c(0.941,0.991), burnin=20, ar="Neyman",nsim=10^1, measure="lrr")